          ...
          <Link
            ...
            className={`group relative flex items-center justify-between rounded-[10px] px-3 py-2 text-[13px] font-medium transition-all ${
              active
                ...
                : "text-zinc-700 dark:text-zinc-300 hover:bg-[#e5e4e6] dark:hover:bg-zinc-800/60 hover:text-zinc-900 dark:hover:text-white border border-transparent"
            }`}
          >
                ...
                <span
                  className={`ml-auto shrink-0 px-2 py-[1px] rounded-full text-[11px] font-mono font-medium transition-colors ${
                    active
                      ...
                      : "bg-[#e5e4e6] dark:bg-zinc-800 text-zinc-700 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-200"
                  }`}
                >
                  {link.count}
                </span>
