    ...
    <div className="flex flex-col gap-3 font-sans antialiased">
      <div>
        <div className="flex items-center gap-2 pb-3 border-b border-zinc-200 dark:border-zinc-800 mb-3">
          ...
          <h2 className="text-sm font-bold uppercase tracking-wide text-zinc-800 dark:text-zinc-200">Identity graph</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div>
            <p className="text-xs uppercase text-zinc-500 dark:text-zinc-500 font-bold">Operator</p>
          ...
          <div>
            <p className="text-xs uppercase text-zinc-500 dark:text-zinc-500 font-bold">Sole authority</p>
      ...
      {identityGraph.collisions.length > 0 && (
        <div className="rounded-xl border border-amber-200 dark:border-amber-900/40 bg-amber-50/40 dark:bg-amber-950/10 p-4">
          <h3 className="text-[13px] font-bold uppercase tracking-wide text-amber-800 dark:text-amber-300 mb-2">
