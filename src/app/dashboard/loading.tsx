...
export default function DashboardLoading() {
  ...
  <div className="h-5 w-32 rounded-sm bg-zinc-100 dark:bg-zinc-900" />
               <div className="h-3.5 w-64 rounded-sm bg-zinc-100 dark:bg-zinc-900" />
        </div>
         <div className="h-7 w-56 rounded-sm bg-zinc-100 dark:bg-zinc-900" />
      </div>

      {/* Overview stats */}
      <div className="border-b border-zinc-200 dark:border-zinc-900 pb-4">
             <div className="h-3 w-20 rounded-sm bg-zinc-100 dark:bg-zinc-900 mb-4" />
        <div className="grid gap-4 sm:grid-cols-3 pt-1 border-t border-zinc-200/60 dark:border-zinc-900/20">
          {[0, 1, 2].map((i) => (
            ...
            <div className="h-7 w-12 rounded-sm bg-zinc-100 dark:bg-zinc-900" />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="pt-2">
        ...
        <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden">
          ...
          {[0, 1, 2, 3].map((i) => (
            ...
            >
     <div className="h-3 w-full max-w-[280px] rounded-sm bg-zinc-100 dark:bg-zinc-900" />
            </div>
          ))}
        </div>
      </div>
