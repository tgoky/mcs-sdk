...
export const DEFAULT_FORM: FormData = {
  ...
  bookingSaveForReuse: false,
  bookingReuseLabel: "",
  emailApiKey: "",
  emailCredentialVaultId: "",
  emailSaveForReuse: false,
  emailReuseLabel: "",
  ghlApiKey: "",
  ghlCredentialVaultId: "",
  ghlSaveForReuse: false,
  ghlReuseLabel: "",
  ghlLocationId: "",
  testimonials: [],
