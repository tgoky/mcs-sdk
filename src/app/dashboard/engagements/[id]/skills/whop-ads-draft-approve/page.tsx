// src/app/dashboard/engagements/[id]/skills/whop-ads-draft-approve/page.tsx
...
import { AdsConsole } from "./ads-console";

export const revalidate = 0;

/** Section 11.12 — Whop Ads workspace. */
export default async function WhopAdsDraftApprovePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-4 font-sans antialiased">
      <SetBreadcrumbLabel label={`${engagement.buyer} · Whop Ads`} />
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-zinc-900 dark:text-white tracking-tight">Whop Ads — {engagement.buyer}</h1>
      </div>
      <AdsConsole engagementId={id} />
    </div>
  );
}
