// src/app/dashboard/engagements/[id]/skills/whop-dispute-response/page.tsx
...
import { DisputeResponseConsole } from "./dispute-response-console";

export const revalidate = 0;

/** Section 11.10 — Dispute workspace. */
export default async function WhopDisputeResponsePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-4 font-sans antialiased">
      <SetBreadcrumbLabel label={`${engagement.buyer} · Dispute Response`} />
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-zinc-900 dark:text-white tracking-tight">Dispute Response — {engagement.buyer}</h1>
      </div>
      <DisputeResponseConsole engagementId={id} />
    </div>
  );
}
