...
export function ApprovalModeToggle({
  ...
  if (requireApproval) {
    return (
      <div className="flex items-center gap-2">
        <span className="inline-flex items-center gap-1 text-[11px] font-mono font-bold text-gold-hover dark:text-gold bg-gold/10 border border-gold/25 px-2 py-1 rounded-sm">
  ...
  return (
    <div className="flex items-center gap-2">
     <span className="inline-flex items-center gap-1 text-[11px] font-mono font-bold text-zinc-600 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-900/60 px-2 py-1 rounded-sm">
