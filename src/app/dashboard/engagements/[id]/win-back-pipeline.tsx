  ...
  const toneClasses =
    {
      ...
      // HIGH-CONTRAST #aab8d8 (LIGHT) & #b7eacd (DARK) STYLING WITHOUT GLOWING DOT
      warning: "bg-[#aab8d8] text-zinc-950 dark:bg-[#b7eacd] dark:text-zinc-950 font-bold border-0 shadow-xs",
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                ...
                                isActive && !isSelected && "bg-[#aab8d8]/20 dark:bg-[#b7eacd]/10",
                                isSelected && "bg-[#aab8d8]/35 dark:bg-[#b7eacd]/25 ring-1 ring-[#aab8d8] dark:ring-[#b7eacd]",
                                !isActive && !isSelected && "bg-white dark:bg-transparent hover:bg-zinc-100/80 dark:hover:bg-zinc-800/50"
                              )}
                            >
                              <div className="flex items-center gap-3 min-w-0 flex-1">
                                <span className="flex items-center gap-1 text-[10px] font-mono font-bold text-zinc-950 bg-[#aab8d8] dark:bg-[#b7eacd] px-1.5 py-0.5 rounded shrink-0">
                                  <Clock size={9} />
                                  {enrollmentTime}
                                </span>
            ...
            <>
              ...
              <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-transparent p-3 space-y-2 text-xs font-sans">
                ...
                <div className="h-1.5 rounded-full bg-zinc-200 dark:bg-zinc-700 overflow-hidden">
                  <div className="h-full bg-[#aab8d8] dark:bg-[#b7eacd]" style={{ width: `${selected.touchesTotal ? (selected.touchesSent / selected.touchesTotal) * 100 : 0}%` }} />
                </div>
                ...
                <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-transparent p-3 space-y-2 text-xs font-sans">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 shrink-0 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-[#aab8d8] dark:bg-[#b7eacd] text-zinc-950 px-2 py-1 text-[11px] hover:opacity-90 cursor-pointer font-sans font-bold"
                    >
