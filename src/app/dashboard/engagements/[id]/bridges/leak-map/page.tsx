  ...
  return (
    <div className="space-y-4 font-sans antialiased">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-zinc-900 dark:text-white tracking-tight">Configure {WORKER_REGISTRY["leak-map"].name}</h1>
      </div>

      <LeakMapConfigForm engagementId={id} onCancel={() => router.push(backHref)} />
    </div>
  );
}
