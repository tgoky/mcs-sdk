            ...
            {gridDays.map(({ date, isCurrentMonth }, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {metric && metric.totalCalls > 0 ? (
  <div className="rounded-lg bg-[#fde2e8] dark:bg-pink-950/50 px-2 py-1.5 transition-colors group-hover:bg-[#fbcfe8] dark:group-hover:bg-pink-900/60">
    <span className="text-[11px] font-bold block leading-none text-pink-950 dark:text-pink-100 font-sans">
      {metric.totalCalls} call{metric.totalCalls === 1 ? "" : "s"}
    </span>
    <span className="text-[9.5px] font-mono mt-0.5 block font-semibold text-pink-800 dark:text-pink-300">
