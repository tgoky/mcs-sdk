                          ...
                          >
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              {item.overallSeverity === "none" ? (
                                <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold tracking-wider uppercase border border-[#d3c9ea] bg-[#ece8f5] text-[#4a3b69] shrink-0">
                                  Clean
                                </span>
                              ) : (
                ...
                <div className="flex items-center justify-between font-sans flex-wrap gap-1">
                  ...
                  <div className="flex items-center gap-2">
                    {selected.overallSeverity === "none" ? (
                      <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold tracking-wider uppercase border border-[#d3c9ea] bg-[#ece8f5] text-[#4a3b69]">
                        Clean
                      </span>
                    ) : (
                      <StatusPill tone={toneFromSeverity(selected.overallSeverity)} className="capitalize">
                        {`${selected.overallSeverity} severity`}
                      </StatusPill>
                    )}
                    ...
                    {!detailLoading && !detailError && detail && "audit" in detail && (
                      <div className="embedded-leak-map font-sans text-xs">
                        <style>{`
                          ...
                          /* Ensure clear light theme for report tiles */
