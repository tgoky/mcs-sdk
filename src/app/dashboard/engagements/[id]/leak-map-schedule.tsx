...
export function LeakMapSchedule({ engagementId }: { engagementId: string }) {
  ...
  return (
    <div className="flex flex-col gap-3 font-sans antialiased">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-zinc-200 bg-white p-2 shadow-xs font-sans">
        <div className="flex flex-wrap items-center gap-2">
          <div className="flex items-center gap-1 bg-zinc-50 rounded-xl border border-zinc-200 p-1">
            <button
              type="button"
              onClick={() => handleMonthChange(new Date(year, month - 1, 1))}
              className="rounded-lg p-1 text-zinc-600 hover:bg-zinc-200/60 hover:text-zinc-900 cursor-pointer"
            >
              <ChevronLeft size={14} />
            </button>
            <span className="text-xs font-bold text-zinc-900 font-sans px-1 min-w-[100px] text-center">
              {monthName} {year}
            </span>
            <button
              type="button"
            ...
            <button
              ...
              className="rounded-md border border-zinc-200 bg-white px-2 py-0.5 text-[10.5px] font-semibold text-zinc-700 hover:bg-zinc-100 cursor-pointer font-sans ml-0.5"
            >
              Today
            </button>
          </div>
          ...
          <div className="relative w-56">
            ...
            <input
              ...
              className="w-full rounded-xl border border-zinc-200 bg-white py-1.5 pl-8 pr-2.5 text-xs text-zinc-900 placeholder:text-zinc-400 focus:border-zinc-400 focus:outline-none font-sans"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 font-sans">
          <button
            ...
            onClick={load}
            disabled={loading}
            className="flex items-center gap-1 rounded-xl border border-zinc-200 bg-white px-2.5 py-1.5 text-xs text-zinc-600 hover:text-zinc-900 transition-colors cursor-pointer font-sans"
          >
      ...
      {error && (
        <div className="rounded-xl border border-rose-200 bg-rose-50 px-3 py-2 text-xs text-rose-800 font-sans">{error}</div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 font-sans">
        ...
        <div className="lg:col-span-7 space-y-3 font-sans">
          {!loading && scheduled.length > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {scheduled.map((s) => (
                <div
                  key={s.auditType}
                  className="flex items-center gap-2.5 rounded-2xl border border-zinc-200 bg-white p-3 shadow-xs font-sans"
                >
                  <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-zinc-100 text-zinc-900 font-bold shrink-0">
          ...
          {!loading && alerts.length > 0 && (
            <div className="rounded-2xl border border-rose-200 bg-rose-50/80 p-3.5 font-sans space-y-2">
              ...
              <div className="space-y-1">
                {alerts.map((a) => (
                  <div key={a.id} className="flex items-center justify-between text-xs text-rose-950 font-sans">
          ...
          <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-xs font-sans flex flex-col">
            <div className="flex items-center justify-between px-4 py-2.5 border-b border-zinc-200 bg-zinc-50/80 font-sans">
              ...
              <div className="flex items-center gap-1 bg-zinc-100 p-0.5 rounded-lg border border-zinc-200 text-[11px] font-sans">
                <button
                  type="button"
                  onClick={() => setListScope("week")}
                  className={cn(
                    "px-2 py-0.5 rounded-md font-semibold transition-colors cursor-pointer font-sans",
                    listScope === "week" ? "bg-white text-zinc-900 shadow-xs" : "text-zinc-500 hover:text-zinc-900"
                  )}
                >
                  Current Week
                </button>
                <button
                  ...
                  className={cn(
                    "px-2 py-0.5 rounded-md font-semibold transition-colors cursor-pointer font-sans",
                    listScope === "month" ? "bg-white text-zinc-900 shadow-xs" : "text-zinc-500 hover:text-zinc-900"
                  )}
                >
                  Full Month
                </button>
            ...
            {listDaysToRender.length === 0 && !loading ? (
              <div className="flex flex-col items-center gap-2 py-12 text-zinc-400 font-sans">
                <CalendarX2 size={22} />
              ...
              <div className="divide-y divide-zinc-200 max-h-[500px] overflow-y-auto">
                {listDaysToRender.map(({ dateStr, audits }) => (
                  <div key={dateStr} className="space-y-0 font-sans">
                    <div className="sticky top-0 z-10 flex items-center justify-between bg-zinc-50/95 backdrop-blur-xs px-4 py-1.5 border-b border-zinc-200 text-[10.5px] font-mono font-bold uppercase tracking-wider text-zinc-500">
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-3 min-w-0 flex-1">
                              <span className="flex items-center gap-1 text-[10px] font-mono font-bold text-zinc-700 bg-zinc-100 border border-zinc-200 px-1.5 py-0.5 rounded shrink-0">
                                <Clock size={9} />
                                {timeBadge}
                              </span>

                              <div className="min-w-0 space-y-0.5">
                                <span className="truncate text-xs font-bold text-zinc-900 block font-sans">
        ...
        <div className="lg:col-span-5 rounded-2xl border border-zinc-200 bg-white p-4 space-y-4 shadow-xs font-sans">
          {selected ? (
            <>
              <div className="space-y-2 border-b border-zinc-200 pb-3 font-sans">
                ...
                <h4 className="text-base font-bold text-zinc-900 font-sans">
              ...
              <div className="grid grid-cols-3 gap-2 font-sans text-center">
                <div className="rounded-xl border border-zinc-200 bg-zinc-50/50 p-2 space-y-0.5">
                  <span className="text-[10px] font-mono text-zinc-500 uppercase block font-bold">Issues</span>
                  <span className="text-base font-bold text-zinc-900 font-mono">{selected.topIssueCount}</span>
                </div>
                <div className="rounded-xl border border-zinc-200 bg-zinc-50/50 p-2 space-y-0.5">
                  <span className="text-[10px] font-mono text-zinc-500 uppercase block font-bold">Alerts</span>
                  <span className="text-base font-bold text-zinc-900 font-mono">{selected.alertsFiredCount}</span>
                </div>
                <div className="rounded-xl border border-zinc-200 bg-zinc-50/50 p-2 space-y-0.5">
                  <span className="text-[10px] font-mono text-zinc-500 uppercase block font-bold">Gaps</span>
                  <span className="text-base font-bold text-zinc-900 font-mono">{selected.gapsCount}</span>
                </div>
              </div>
              ...
              {selected.runId && (
                <div className="space-y-2 font-sans">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-800 font-sans">
                      Audit Diagnostic Report
                    </span>
                    <a
                      href={`/dashboard/runs/${selected.runId}`}
                      className="inline-flex items-center gap-1 text-[10.5px] text-zinc-600 hover:text-zinc-900 transition-colors font-medium font-sans"
                    >
                  ...
                  <div className="rounded-xl border border-zinc-200 bg-white text-zinc-900 p-3 max-h-[320px] overflow-y-auto text-xs font-sans relative">
                    {detailLoading && (
                    ...
                    {detailError && (
                      <p className="text-[11px] text-rose-600 font-sans">{detailError}</p>
                    )}
                    {!detailLoading && !detailError && detail && "audit" in detail && (
                      <div className="embedded-leak-map font-sans text-xs">
                        <style>{`
                          ...
                          /* Hide Board view button */
                          .embedded-leak-map button:nth-child(3) {
                            display: none !important;
                          }

                          /* OVERRIDE ALL GRAYS INSIDE THE REPORT TO CLEAN LIGHT MODE */
                          .embedded-leak-map,
                          .embedded-leak-map *,
                          .embedded-leak-map span,
                          .embedded-leak-map p,
                          .embedded-leak-map div,
                          .embedded-leak-map button {
                            color: #09090b !important;
                          }

                          /* Force card elements & containers to white or ultra-light zinc */
                          .embedded-leak-map div,
                          .embedded-leak-map section,
                          .embedded-leak-map article {
                            background-color: #ffffff !important;
                            border-color: #e4e4e7 !important;
                          }

                          /* Force any inner dark-gray card styles (like metric cards) to light backgrounds */
                          .embedded-leak-map [class*="bg-zinc-"],
                          .embedded-leak-map [class*="bg-slate-"],
                          .embedded-leak-map [class*="bg-gray-"],
                          .embedded-leak-map [class*="bg-neutral-"],
                          .embedded-leak-map [class*="bg-black"] {
                            background-color: #f4f4f5 !important;
                            border-color: #e4e4e7 !important;
                          }

                          /* Inner light badges */
                          .embedded-leak-map span[class*="bg-"] {
