        ...
        {entry && (
          <>
            ...
            <SheetBody className="space-y-4 font-sans pt-2">
              ...
              {entry.runId && (
                <a href={`/dashboard/runs/${entry.runId}`} className="inline-flex items-center gap-1.5 text-xs font-semibold text-zinc-300 hover:text-white font-sans">
                  View the run that generated this brief <ExternalLink size={11} />
                </a>
              )}
            </SheetBody>
          </>
