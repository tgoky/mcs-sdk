...
export default async function ShowtimePackagePage() {
  ...
  return (
    <div className="w-full max-w-5xl space-y-8 px-6 py-6 font-sans">
      ...
      <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800/80 bg-zinc-50/50 dark:bg-zinc-900/40 p-6 space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 pt-1">
            <div className="flex items-center gap-2.5 flex-wrap">
              <h1 className="text-xl font-bold text-zinc-900 dark:text-white">Showtime</h1>
              
              {/* Adaptive Filled Download Icon + Installed Text */}
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-zinc-900 dark:text-white">
                <Download size={13} className="fill-current text-zinc-900 dark:text-white" />
                Installed &amp; active
              </span>
            </div>
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1 leading-relaxed max-w-xl">
        ...
        <div className="flex items-center gap-8 pt-2 border-t border-zinc-200 dark:border-zinc-800/60">
