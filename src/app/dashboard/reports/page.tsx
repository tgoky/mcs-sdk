    ...
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed max-w-2xl">
          A per-client quality breakdown — for Showtime, bookings/show rate/Win-Back/approvals; for Reputation
          Manager, mentions/sentiment/flags/incidents. Not portfolio-wide trends — for cross-client charts, see
          Analytics.
        </p>
      </div>
