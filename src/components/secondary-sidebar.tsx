...
/**
 * Six DB-backed slots are all fetched together in layout.tsx (each behind
 * its own Suspense boundary, same reasoning as the old SidebarNav/
 * SidebarSkills split — see work-sidebar.tsx's file comment) and handed
 * down as props here. This component's only job is picking which one is
 * visible for the current route — it's a client component purely because
 * usePathname() requires one, not because it does any data fetching itself.
 */
