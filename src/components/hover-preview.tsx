...
export function HoverPreview({
  ...
  return createPortal(
    ...
    >
      <div className="rounded-xl border border-border bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md shadow-xl dark:shadow-2xl dark:shadow-black/50 p-4 text-xs font-mono text-zinc-800 dark:text-zinc-200 leading-normal">
        {preview}
      </div>
    </div>,
    document.body
