 ...
 * out of the way rather than to make an impression.
 */
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  main { max-width: 520px; margin: 0 auto; padding: 100px 24px 120px; }

  h1 { font-size: 1.7rem; font-weight: 600; letter-spacing: -0.02em; line-height: 1.25; margin: 0 0 14px; }
  .sub { font-size: 0.95rem; color: #6B6B6B; margin: 0 0 56px; line-height: 1.6; max-width: 42ch; }
...
<body>
<main>
  <h1>You're confirmed, ${m.buyer}.</h1>
  ...
  <section>
    ...
    <span class="tag">${m.heroLength}</span>
  </section>
