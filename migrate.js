...
var migrationClient = (0, postgres_1.default)(process.env.DIRECT_URL, { max: 1, prepare: false });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, migrator_1.migrate)((0, postgres_js_1.drizzle)(migrationClient), {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, migrationClient.end()];
                case 2:
                    // Cleanly close the database connection pool
                    _a.sent();
                    process.exit(0);
